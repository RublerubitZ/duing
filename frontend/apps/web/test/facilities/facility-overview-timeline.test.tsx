...
describe('FacilityOverviewTimeline', () => {
  ...
  it('다음 예약이 오늘이면 시간만, 다른 날이면 M/D 를 병기한다', () => {
    render(
      <FacilityOverviewTimeline
        facilities={[
          {
    ...
    expect(screen.getByText(/다음 예약 16:00~17:00/)).toBeInTheDocument();
    expect(screen.getByText(/다음 예약 7\/4 16:00~17:00/)).toBeInTheDocument();
  });
