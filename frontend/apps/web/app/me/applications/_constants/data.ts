...
export const APPS: App[] = [
  {
    ...
    steps: [
      { label: '서류접수',    date: '2026.05.15',      state: 'done' },
      { label: '서류심사',    date: '2026.05.18',      state: 'done' },
      { label: '면접/인터뷰', date: '2026.05.27 예정', state: 'current' },
      { label: '최종발표',    date: '-',               state: 'pending' },
    ],
    status: 'interview-scheduled',
    right: { eyebrow: '면접일', value: '2026.05.29 (금)', sub: '14:00' },
  ...
  },
  {
    ...
    steps: [
      { label: '서류접수',    date: '2026.05.04', state: 'done' },
      { label: '서류심사',    date: '2026.05.08', state: 'done' },
      { label: '면접/인터뷰', date: '2026.05.14', state: 'done' },
      { label: '최종발표',    date: '2026.05.18', state: 'done' },
    ],
    status: 'passed',
    right: { eyebrow: '합격일', value: '2026.05.18' },
  ...
  },
  {
    ...
    appliedAt: '2026.05.11 (월) 11:22',
    division: '일반 지원',
    department: '프로젝트팀',
    files: [{ type: '지원서 파일', name: '지원서_링크_김두잉.pdf' }],
    memo: '여러 학교 학생들과 협업하는 프로젝트에 도전하고 싶어요.',
    steps: [
      { label: '서류접수',    date: '2026.05.11', state: 'done' },
      { label: '서류심사',    date: '심사 중',    state: 'current' },
      { label: '면접/인터뷰', date: '-',          state: 'pending' },
      { label: '최종발표',    date: '-',          state: 'pending' },
    ],
    status: 'doc-review',
    right: { eyebrow: '결과 발표 예정', value: '2026.05.22 (금)' },
  ...
  },
  {
    ...
    steps: [
      { label: '서류접수',    date: '2026.05.01', state: 'done' },
      { label: '서류심사',    date: '2026.05.06', state: 'done' },
      { label: '면접/인터뷰', date: '2026.05.09', state: 'done' },
      { label: '최종발표',    date: '2026.05.13', state: 'failed' },
    ],
    status: 'failed',
    right: { eyebrow: '발표일', value: '2026.05.13' },
  ...
  },
  {
    ...
    steps: [
      { label: '서류접수',    date: '2026.05.09',      state: 'done' },
      { label: '서류심사',    date: '2026.05.14',      state: 'done' },
      { label: '면접/인터뷰', date: '2026.05.28 예정', state: 'current' },
      { label: '최종발표',    date: '-',               state: 'pending' },
    ],
    status: 'interview-scheduled',
    right: { eyebrow: '면접일', value: '2026.05.28 (목)', sub: '16:00' },
  ...
  },
  {
    ...
    steps: [
      { label: '서류접수',    date: '2026.05.01', state: 'done' },
      { label: '서류심사',    date: '2026.05.06', state: 'done' },
      { label: '면접/인터뷰', date: '2026.05.11', state: 'done' },
      { label: '최종발표',    date: '2026.05.15', state: 'done' },
    ],
    status: 'passed',
    right: { eyebrow: '합격일', value: '2026.05.15' },
