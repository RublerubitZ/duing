...
export function BookingPanel({
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="sticky bottom-0 bg-paper pt-2 max-md:fixed max-md:inset-x-0 max-md:bottom-[calc(3.5rem_+_env(safe-area-inset-bottom))] max-md:z-40 max-md:border-t max-md:border-line max-md:px-4 max-md:pb-2">
        {selection && (
