...
export function Hero() {
  return (
    <section className="bg-grid relative overflow-hidden">
      <HeroBackdrop />
      <div className="relative z-10 mx-auto grid max-w-layout items-center gap-10 px-4 pb-16 pt-8 sm:px-6 md:grid-cols-[1.05fr_0.95fr] md:gap-14 md:px-10 md:pb-24 md:pt-10">
        {/* ── 텍스트 (은은한 패럴랙스) ── */}
