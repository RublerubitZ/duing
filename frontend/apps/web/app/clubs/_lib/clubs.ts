...
> = {
  ...
  // (fg 는 파스텔 배경 위 조합이라 학술·문화·친목이 전부 잉크로 겹친다). 색상값은 기존 pill 팔레트 재사용.
  ...
  '문화': { bg: 'bg-sage-tint', fg: 'text-ink',       text: 'text-[#7E2A45]', bgValue: 'var(--sage-tint)',  fgValue: 'var(--ink)',      emoji: '🎨', num: '06' },
  'IT':   { bg: 'bg-[#E3E9E1]', fg: 'text-ink-deep',  text: 'text-ink-deep',  bgValue: '#E3E9E1',           fgValue: 'var(--ink-deep)', emoji: '💻', num: '07' },
  '창업': { bg: 'bg-[#FBEFD7]', fg: 'text-[#8E6620]', text: 'text-[#8E6620]', bgValue: '#FBEFD7',           fgValue: '#8E6620',         emoji: '🚀', num: '08' },
  '친목': { bg: 'bg-sage-mist', fg: 'text-ink',       text: 'text-[#9A3F23]', bgValue: 'var(--sage-mist)',  fgValue: 'var(--ink)',      emoji: '🍻', num: '09' },
};
