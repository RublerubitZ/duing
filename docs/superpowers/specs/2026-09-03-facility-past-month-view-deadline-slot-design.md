...
- 후속 적용 후(BE a760ee0f + FE 335ab050) 재QA: 실제 9/4 는 `applicationClosed=true` 로 잠기고(13행·note·CTA), 응답 가로채기로 만든 "빈 칸 0개 마감일"(전부 BLOCKED·PENDING_HOLD, DEADLINE_PASSED 0개)에서 대기 행 disabled·note 노출·CTA 비활성·주간 대기 블록 비활성 확인, `applicationClosed=false` 강제 시 슬롯 파생을 눌러 행 활성·note 없음. **잔여 한계 해소 확인.**
