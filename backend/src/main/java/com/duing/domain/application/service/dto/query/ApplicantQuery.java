...
public record ApplicantQuery(
    ...
    /**
     * {@code row} 의 interviewStartAt 은 ASSIGNED InterviewSchedule 이 가리키는 슬롯의 startTime 으로
     ...
     */
    public static ApplicantQuery of(ApplicantRowQuery row, List<RecruitmentQuestion> formQuestions) {
        ...
        Map<String, ApplicationAnswer> answerByQuestionId = row.answers().stream()
