...
-- 정합성(chk_fee_policy_auto_issue): 자동발행이 켜진 정책은 MONTHLY + 발행/마감일 NOT NULL·1~28 + 마감일 >= 발행일.
...
ALTER TABLE fee_policy ADD CONSTRAINT chk_fee_policy_auto_issue CHECK (
    auto_issue = FALSE
